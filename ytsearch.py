...
if __name__ == '__main__':
	...
	def PlaylistAPIExample():
		...
		json.dump(api.playlist('PLmtS5lzk1pBT-lDvSubQEdhmAEIyduTeq'), open('Welsknight.json', 'w'), indent=4)
		json.dump(api.playlist('PL3e14exB92LIc7GfSBQHqDC3JyopavrH7'), open('xbCrafted.json', 'w'), indent=4)
		json.dump(api.playlist('PL7VmhWGNRxKhmCu3twJ6ZB3Wt7wdK-L6S'), open('XisumaVoid.json', 'w'), indent=4)
